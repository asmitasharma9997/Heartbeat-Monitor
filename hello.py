...
def CheckLogin():
    ...
    if nameEL.get() == uname and pwordEL.get() == pword: # Checks to see if you entered the correct data.
        ...
        y= Label(r, text=count1) # More labels
        ...
        if(count1>70):
            ...
            txt= Label(n, text="sending message to emergency contact")
            txt.grid(row=1,column=2, sticky=E)
            # gsm(msg1)
            # print(cancel)
